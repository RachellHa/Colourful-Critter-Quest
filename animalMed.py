...
class AnimalMed:
    """
    Author: Lily So
    This class is for the medium level of the animal typing safari game.
    """
    def __init__(self, screen, animals, game_state):
        """
        This method initializes the medium level of the animal typing safari game.
        ...
        self.selected_animal = None #selected animal
        self.animal_index = 0
        self.iter = 0 #the iterations of the animal keys in list
        #convert animal dict into list of keys
        self.animal_keys = list(animals.keys()) #convert dict keys into list of keys
    ...
    def multiple_choice(self, animal_keys):
        ...
        :param animal_keys: the list of animal keys
        """
    ...
    def run(self):
        """
        This method runs the game and displays the interface of the medium level.
        """
        ...
        #define multiple choice buttons values
        col_value = 2
        row_value = 2
        button_width = 220
        button_height = 250
    ...
    def user_input(self, event, save):
        ...
        if event.type == pygame.MOUSEBUTTONDOWN and self.selected_option is None:
            #if user clicked on congrats screen
            if self.questions_answered == 10:
            ...
            if not self.answered:
                ...
                #play animal sound if hint button is clicked
            ...
            if event.key == pygame.K_h:
                ...
                animal_sound = animal_data["sound"]
                animal_sound.play()
        #if user hovers over an option, change to hover image
